...
def write_doc(caps, tot, base, par, par2, dpm, dugf):
    L = ["# Parasitic RC re-simulation (production full-W layout)\n",
         "> This is the **`miller_ota`** pass. The amplifier that meets the "
         "distortion spec is `miller_rrf2`, and its post-layout pass — which "
         "reaches a materially different conclusion — is "
         "[`parasitics-rrf2.md`](parasitics-rrf2.md).\n",
